...
The embedded agent application allows your live agents to view a history of the end users conversation with Watson Assistant to better understand their needs.
...
## Viewing Agent App via HTML/JavaScript
